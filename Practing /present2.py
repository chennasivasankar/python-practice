...
div_average_1and_2 = int(div_average_1and_2) if div_average_1and_2 else 1
overall_rating = round((video_evaluation_score+average_score)/div_average_1and_2, 2)
